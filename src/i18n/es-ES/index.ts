...
export default {
  ...
  actionsEditor: {
    ...
    editActionTooltip: 'Editar acción',
    deleteActionTooltip: 'Eliminar acción',
    ...
    dialog: {
      ...
      addItem: 'Añadir Item de Inventario',
    },
    dialogs: {
      modifyStat: {
        ...
        operationLabel: 'Operación y Valor',
        operationHint: 'Ejemplos: -10, +5, 20',
      },
      setFlag: {
        title: 'Establecer Evento',
        message: 'Introduce el nombre del evento (ej: "puerta_abierta"). Se establecerá a "true".',
        idLabel: 'ID',
        idHint: 'Identificador único',
      },
      addItem: {
        title: 'Añadir Item de Inventario',
        sectionLabel: 'Sección de Inventario',
        nameLabel: 'Nombre del Item',
        descriptionLabel: 'Descripción',
        modifiersTitle: 'Modificadores',
        modifierStat: 'Estadística',
        modifierValue: 'Valor',
    ...
    descriptions: {
      ...
      addItem: 'Añadir Item: {item} a {section}',
  ...
  editChoiceDialog: {
    ...
    statLabel: 'Estadística',
    eventLabel: 'Evento',
    eventStateLabel: 'Estado',
    eventActive: 'Activo',
    eventInactive: 'Inactivo',
    itemLabel: 'Objeto',
    itemHint: 'Nombre del objeto en el inventario',
    itemStateLabel: 'Estado',
    itemExists: 'Existe',
    itemNotExists: 'No existe',
    ...
    skillCheck: {
      ...
      successTextLabel: 'Texto si se cumple (opcional)',
      failureTextLabel: 'Texto si se falla (opcional)',
    },
  },
  assetsPage: {
  ...
  characterSheet: {
    ...
    editItemDialog: {
      ...
      editEffectTooltip: 'Editar efecto',
      deleteEffectTooltip: 'Eliminar efecto',
      updateEffectTooltip: 'Actualizar efecto',
