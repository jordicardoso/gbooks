...
export default {
  ...
  actionsEditor: {
    title: 'Действия при входе в узел',
    addActionTooltip: 'Добавить новое действие',
    editActionTooltip: 'Изменить действие',
    deleteActionTooltip: 'Удалить действие',
    noActions: 'Нет действий для этого узла.',
    noNestedActions: 'Нет действий',
    successActionsTitle: 'При УСПЕХЕ, выполнить:',
    failureActionsTitle: 'При ПРОВАЛЕ, выполнить:',
    removeConditionButton: 'Удалить условие',
    condition: {
      title: 'Условие',
      sourceLabel: 'Тип',
      subjectLabelStat: 'Характеристика для проверки',
      subjectLabelFlag: 'Событие для проверки',
      valueLabel: 'Значение',
      valueTrue: 'Включено',
      valueFalse: 'Выключено',
      sources: {
        stat: 'Характеристика',
        flag: 'Событие',
      },
    ...
    dialog: {
      title: 'Выберите тип действия',
      conditional: 'Условное действие (Если... то...)',
      modifyStat: 'Изменить характеристику',
      setFlag: 'Установить событие',
    },
    dialogs: {
      modifyStat: {
        title: 'Изменить характеристику',
        message: 'Определите характеристику, операцию и значение.',
        statLabel: 'Характеристика',
        operationLabel: 'Операция и значение',
        operationHint: 'Примеры: -10, +5, 20',
      },
      setFlag: {
        title: 'Установить событие',
        message: 'Введите название события (напр., "дверь_открыта"). Будет установлено в "true".',
      },
    },
    createEventDialog: {
      title: 'Создать новое событие',
      message:
        'Вы создаете новое событие с описанием: "{eventName}". Пожалуйста, введите уникальный код для его идентификации (без пробелов и специальных символов).',
      promptLabel: 'Код события (ID)',
    },
    descriptions: {
      modifyStat: 'Характеристика: {stat} {operation} {value}',
      setFlag: 'Событие: {flag} = {value}',
      conditional: 'ЕСЛИ ({subject} {operator} {value}) ТО...',
  ...
  assetsPage: {
    ...
    dialogs: {
      ...
      editChoice: {
        ...
        conditionTypeLabel: 'Тип условия',
        conditionTypes: {
          stat: 'Статистика',
          event: 'Событие',
          item: 'Инвентарь',
        ...
        eventLabel: 'Событие',
        eventStateLabel: 'Состояние',
        eventActive: 'Активно',
        eventInactive: 'Неактивно',
        itemLabel: 'Предмет',
        itemHint: 'Название предмета в инвентаре',
        itemStateLabel: 'Состояние',
        itemExists: 'Существует',
        itemNotExists: 'Не существует',
  ...
  characterSheet: {
    ...
    editItemDialog: {
      ...
      editEffectTooltip: 'Изменить эффект',
      deleteEffectTooltip: 'Удалить эффект',
      updateEffectTooltip: 'Обновить эффект',
