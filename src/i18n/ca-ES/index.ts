...
export default {
  ...
  dialogs: {
    ...
    editChoice: {
      ...
      conditionTitle: 'Condició',
      conditionTypeLabel: 'Tipus de condició',
      conditionTypes: {
        stat: 'Estadística',
        event: 'Esdeveniment',
        item: 'Inventari',
      ...
      eventStateLabel: 'Estat',
      eventActive: 'Actiu',
      eventInactive: 'Inactiu',
      itemLabel: 'Objecte',
      itemHint: "Nom de l'objecte a l'inventari",
      itemStateLabel: 'Estat',
      itemExists: 'Existeix',
      itemNotExists: 'No existeix',
  ...
  actionsEditor: {
    title: 'Accions en Entrar al Node',
    addActionTooltip: 'Afegir una nova acció',
    editActionTooltip: 'Editar acció',
    deleteActionTooltip: 'Eliminar acció',
    noActions: 'No hi ha accions definides per aquest node.',
    noNestedActions: 'Sense accions',
    successActionsTitle: 'Si es COMPLEIX, fer:',
    failureActionsTitle: 'Si FALLA, fer:',
    removeConditionButton: 'Eliminar Condició',
    condition: {
      title: 'Condició',
      sourceLabel: 'Tipus',
      subjectLabelStat: 'Estadística a comprovar',
      subjectLabelFlag: 'Esdeveniment a comprovar',
      valueLabel: 'Valor',
      valueTrue: 'Activat',
      valueFalse: 'Desactivat',
      sources: {
        stat: 'Estadística',
        flag: 'Esdeveniment',
      },
    ...
    dialog: {
      title: "Tria un tipus d'Acció",
      conditional: 'Acció Condicional (Si... llavors...)',
      modifyStat: 'Modificar Estadística',
      setFlag: 'Establir Esdeveniment',
    },
    dialogs: {
      modifyStat: {
        title: 'Modificar Estadística',
        message: "Defineix l'estadística, l'operació i el valor.",
        statLabel: 'Estadística',
        operationLabel: 'Operació i Valor',
        operationHint: 'Exemples: -10, +5, 20',
      },
      setFlag: {
        title: 'Establir Esdeveniment',
        message:
          'Introdueix el nom de l\'esdeveniment (ex: "porta_oberta"). S\'establirà a "true".',
      },
    },
    createEventDialog: {
      title: 'Crear Nou Esdeveniment',
      message:
        'Estàs creant un nou esdeveniment amb la descripció: "{eventName}". Si us plau, introdueix un codi únic per identificar-lo (sense espais ni caràcters especials).',
      promptLabel: "Descripció de l'Esdeveniment",
    },
    descriptions: {
      modifyStat: 'Estadística: {stat} {operation} {value}',
      setFlag: 'Esdeveniment: {flag} = {value}',
      conditional: 'SI ({subject} {operator} {value}) LLAVORS...',
      unknown: 'Acció desconeguda',
    },
  },
  assetsPage: {
  ...
  characterSheet: {
    ...
    editItemDialog: {
      ...
      editEffectTooltip: 'Editar efecte',
      deleteEffectTooltip: 'Eliminar efecte',
      updateEffectTooltip: 'Actualitzar efecte',
      cancelEditTooltip: 'Cancel·lar edició',
      save: 'Desar',
      cancel: 'Cancel·lar',
    },
  },
